module ValidatesTimeliness
  ...
  def self.enable_multiparameter_extension!
    if ::ActiveSupport::VERSION::MAJOR < 4
      ...
      ::ActiveSupport::Base.send(:include, ValidatesTimeliness::Extensions::AttributeAssignment)
      ::ActiveSupport::AttributeAssignment::MultiparameterAttribute.send(:include, ValidatesTimeliness::Extensions::MultiparameterAttribute)
    end
  end
end
